...
import {View, Text, StyleSheet, TextInput,SafeAreaView,Image, Button,TouchableOpacity,Alert} from 'react-native';
   ...
   check(id){
        ...
        render(){
            return(
                ...
                <Image
                style={styles.img}
                source={require('./Resources/guitar.jpeg')}>
